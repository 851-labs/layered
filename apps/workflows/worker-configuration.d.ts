/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7eb8b806e1db291af1931c4fea031b5a)
...
declare namespace Cloudflare {
	...
	interface Env {
		BUCKET: R2Bucket;
		DB: D1Database;
		UPLOAD_GENERATION_LAYERS_WORKFLOW: Workflow<Parameters<import("./src/index").UploadGenerationLayersWorkflow['run']>[0]['payload']>;
	}
}
