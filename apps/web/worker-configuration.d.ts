/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 34e8480be697e0b65d87a68a30d5b2e8)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		AI: Ai;
		UPLOAD_GENERATION_LAYERS_WORKFLOW: Workflow<Parameters<import("./src/server").UploadGenerationLayersWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FAL_KEY" | "CF_AIG_TOKEN">> {}
}
