/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b13057e90f0e90ddb93d720b98879dde)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		UPLOAD_PREDICTION_BLOBS_WORKFLOW: Workflow<Parameters<import("./src/server").UploadPredictionBlobsWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FAL_KEY" | "CF_AIG_TOKEN">> {}
}
